...
#SBATCH --job-name=SV.Demultiplexing_pt1_1.script
#SBATCH --output=SV.Demultiplexing_pt1_1.output
#SBATCH --error=SV.Demultiplexing_pt1_1.error
...
#/usr/bin/time -v python Demultiplexing_pt1.py -f /projects/bgmp/shared/2017_sequencing/1294_S1_L008_R4_001.fastq.gz -r 101 -H '1294_S1_L008_R4_001' > output.1294_S1_L008_R4_001.tsv
